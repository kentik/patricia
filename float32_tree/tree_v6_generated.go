...
func (t *TreeV6) addTag(tag float32, nodeIndex uint, replaceFirst bool) {
	if replaceFirst {
...
func (t *TreeV6) Set(address patricia.IPv6Address, tag float32) (int, error) {
	return t.add(address, tag, true)
}

// Add adds a tag to the tree
// Returns how many tags at this address
func (t *TreeV6) Add(address patricia.IPv6Address, tag float32) (int, error) {
...
func (t *TreeV6) add(address patricia.IPv6Address, tag float32, replaceFirst bool) (int, error) {
