...
func (t *TreeV4) addTag(tag uint16, nodeIndex uint, replaceFirst bool) {
	if replaceFirst {
...
func (t *TreeV4) Set(address patricia.IPv4Address, tag uint16) (int, error) {
	return t.add(address, tag, true)
}

// Add adds a tag to the tree
// Returns how many tags at this address
func (t *TreeV4) Add(address patricia.IPv4Address, tag uint16) (int, error) {
...
func (t *TreeV4) add(address patricia.IPv4Address, tag uint16, replaceFirst bool) (int, error) {
