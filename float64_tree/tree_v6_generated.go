...
func (t *TreeV6) Set(address patricia.IPv6Address, tag float64) error {
	return t.add(address, tag, true)
}

// Add adds a tag to the tree
func (t *TreeV6) Add(address patricia.IPv6Address, tag float64) error {
...
func (t *TreeV6) add(address patricia.IPv6Address, tag float64, replaceFirst bool) error {
