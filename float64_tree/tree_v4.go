...
func (t *TreeV4) addTag(tag float64, nodeIndex uint, replaceFirst bool) bool {
	ret := true
	if replaceFirst {
...
// Returns whether the tag count at this address was increased, and how many tags at this address
func (t *TreeV4) Add(address patricia.IPv4Address, tag float64) (bool, int, error) {
...
func (t *TreeV4) add(address patricia.IPv4Address, tag float64, replaceFirst bool) (bool, int, error) {
