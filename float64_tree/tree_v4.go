...
func (t *TreeV4) Set(address patricia.IPv4Address, tag float64) error {
	return t.add(address, tag, true)
}

// Add adds a tag to the tree
func (t *TreeV4) Add(address patricia.IPv4Address, tag float64) error {
...
func (t *TreeV4) add(address patricia.IPv4Address, tag float64, replaceFirst bool) error {
