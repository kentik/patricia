...
func (t *TreeV4) addTag(tag rune, nodeIndex uint, replaceFirst bool) bool {
	ret := true
	if replaceFirst {
...
// Returns whether the tag count at this address was increased, and how many tags at this address
func (t *TreeV4) Add(address patricia.IPv4Address, tag rune) (bool, int, error) {
...
func (t *TreeV4) add(address patricia.IPv4Address, tag rune, replaceFirst bool) (bool, int, error) {
