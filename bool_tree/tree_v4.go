...
func (t *TreeV4) addTag(tag bool, nodeIndex uint, replaceFirst bool) bool {
	ret := true
	if replaceFirst {
...
func (t *TreeV4) Set(address patricia.IPv4Address, tag bool) (bool, int, error) {
	return t.add(address, tag, true)
}

// Add adds a tag to the tree
// Returns whether the tag count at this address was increased, and how many tags at this address
func (t *TreeV4) Add(address patricia.IPv4Address, tag bool) (bool, int, error) {
...
func (t *TreeV4) add(address patricia.IPv4Address, tag bool, replaceFirst bool) (bool, int, error) {
...
func (t *TreeV4) FindTagsWithFilter(address patricia.IPv4Address, filterFunc FilterFunc) ([]bool, error) {
	root := &t.nodes[1]
	if filterFunc == nil {
