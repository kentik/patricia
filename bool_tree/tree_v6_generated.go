...
func (t *TreeV6) addTag(tag bool, nodeIndex uint, replaceFirst bool) bool {
	ret := true
	if replaceFirst {
...
// Returns whether the tag count at this address was increased, and how many tags at this address
func (t *TreeV6) Add(address patricia.IPv6Address, tag bool) (bool, int, error) {
...
func (t *TreeV6) add(address patricia.IPv6Address, tag bool, replaceFirst bool) (bool, int, error) {
