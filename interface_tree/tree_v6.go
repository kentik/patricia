...
func (t *TreeV6) Add(address *patricia.IPv6Address, tag interface{}) error {
	// handle root tags
...
func (t *TreeV6) Delete(address *patricia.IPv6Address, matchFunc MatchesFunc, matchVal interface{}) (int, error) {
...
func (t *TreeV6) FindTags(address *patricia.IPv6Address) ([]interface{}, error) {
	var matchCount uint
...
func (t *TreeV6) FindTagsWithFilter(address *patricia.IPv6Address, filterFunc FilterFunc) ([]interface{}, error) {
	if filterFunc == nil {
...
func (t *TreeV6) FindDeepestTag(address *patricia.IPv6Address) (bool, interface{}, error) {
	var found bool
	var ret interface{}
