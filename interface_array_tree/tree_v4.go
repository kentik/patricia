...
func (t *TreeV4) firstTagForNode(nodeIndex uint) []interface{} {
	return t.tags[(uint64(nodeIndex) << 32)]
}

// delete tags at the input node, returning how many were deleted, and how many are left
func (t *TreeV4) deleteTag(nodeIndex uint, matchTag []interface{}, matchFunc MatchesFunc) (int, int) {
...
func (t *TreeV4) Add(address *patricia.IPv4Address, tag []interface{}) error {
...
func (t *TreeV4) Delete(address *patricia.IPv4Address, matchFunc MatchesFunc, matchVal []interface{}) (int, error) {
...
func (t *TreeV4) FindTagsWithFilter(address *patricia.IPv4Address, filterFunc FilterFunc) ([][]interface{}, error) {
	root := &t.nodes[1]
	if filterFunc == nil {
...
func (t *TreeV4) FindTags(address *patricia.IPv4Address) ([][]interface{}, error) {
	var matchCount uint
	root := &t.nodes[1]
	ret := make([][]interface{}, 0)
...
func (t *TreeV4) FindDeepestTag(address *patricia.IPv4Address) (bool, []interface{}, error) {
	root := &t.nodes[1]
	var found bool
	var ret []interface{}
