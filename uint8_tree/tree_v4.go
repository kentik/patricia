...
func (t *TreeV4) Set(address patricia.IPv4Address, tag uint8) error {
	return t.add(address, tag, true)
}

// Add adds a tag to the tree
func (t *TreeV4) Add(address patricia.IPv4Address, tag uint8) error {
...
func (t *TreeV4) add(address patricia.IPv4Address, tag uint8, replaceFirst bool) error {
