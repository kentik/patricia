...
func (t *TreeV4) Set(address patricia.IPv4Address, tag GeneratedType) error {
...
func (t *TreeV4) add(address patricia.IPv4Address, tag GeneratedType, replaceFirst bool) error {
