...
func (t *TreeV6) firstTagForNode(nodeIndex uint) uintptr {
	return t.tags[(uint64(nodeIndex) << 32)]
}

// delete tags at the input node, returning how many were deleted, and how many are left
func (t *TreeV6) deleteTag(nodeIndex uint, matchTag uintptr, matchFunc MatchesFunc) (int, int) {
...
func (t *TreeV6) Add(address *patricia.IPv6Address, tag uintptr) error {
...
func (t *TreeV6) Delete(address *patricia.IPv6Address, matchFunc MatchesFunc, matchVal uintptr) (int, error) {
...
func (t *TreeV6) FindTagsWithFilter(address *patricia.IPv6Address, filterFunc FilterFunc) ([]uintptr, error) {
	root := &t.nodes[1]
	if filterFunc == nil {
...
func (t *TreeV6) FindTags(address *patricia.IPv6Address) ([]uintptr, error) {
	var matchCount uint
	root := &t.nodes[1]
	ret := make([]uintptr, 0)
...
func (t *TreeV6) FindDeepestTag(address *patricia.IPv6Address) (bool, uintptr, error) {
	root := &t.nodes[1]
	var found bool
	var ret uintptr
