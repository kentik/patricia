...
func (t *TreeV4) firstTagForNode(nodeIndex uint) *uintptr {
	return t.tags[(uint64(nodeIndex) << 32)]
}

// delete tags at the input node, returning how many were deleted, and how many are left
func (t *TreeV4) deleteTag(nodeIndex uint, matchTag *uintptr, matchFunc MatchesFunc) (int, int) {
...
func (t *TreeV4) Add(address *patricia.IPv4Address, tag *uintptr) error {
...
func (t *TreeV4) Delete(address *patricia.IPv4Address, matchFunc MatchesFunc, matchVal *uintptr) (int, error) {
...
func (t *TreeV4) FindTagsWithFilter(address *patricia.IPv4Address, filterFunc FilterFunc) ([]*uintptr, error) {
	root := &t.nodes[1]
	if filterFunc == nil {
...
func (t *TreeV4) FindTags(address *patricia.IPv4Address) ([]*uintptr, error) {
	var matchCount uint
	root := &t.nodes[1]
	ret := make([]*uintptr, 0)
...
func (t *TreeV4) FindDeepestTag(address *patricia.IPv4Address) (bool, *uintptr, error) {
	root := &t.nodes[1]
	var found bool
	var ret *uintptr
